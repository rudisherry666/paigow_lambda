...
define([
    ...
    var PGSigninView = Backbone.View.extend({
        ...
        initialize: function(options) {
            ...
            this._options.pgSigninUIModel = new PGSigninUIModel();
        ...
        _addModelListeners: function() {
            this._options.pgSigninUIModel.on("change:state", _.bind(this._showOrHide, this));
        },

        _showOrHide: function() {
            if (this._options.pgSigninUIModel.get('state') === 'static') {
                this._hideStatus();
                this._isShowing = (this._options.pgSigninUIModel.get('username') === "unknown");
                if (this._isShowing) {
                ...
                var status = '';
                switch (this._options.pgSigninUIModel.get('state')) {
        ...
        _signInOrRegister: function(state, username, password) {
            var isRegister = state === 'registering',
                ...
                pModel = this._options.pgSigninUIModel;
